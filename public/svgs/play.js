...
const PlayButton = props => (
    <svg width="282" height="283" viewBox="0 0 282 283" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g filter="url(#filter0_d)">
            <ellipse cx="141" cy="137.5" rx="97" ry="97.5" fill="white" fill-opacity="0.2" />
        ...
        <defs>
            <filter id="filter0_d" x="0" y="0" width="282" height="283" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
