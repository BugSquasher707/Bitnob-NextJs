      ...
      <div className="z-0">
          ...
          <BitNobContainer>
            <div className="mt-10 xl:mt-20 text-center">
              <div>
                ...
                <BitNobButton className="my-6 mb-2 py-3 md:py-auto max-w-xs w-max mx-auto">
                  Get Started
                </BitNobButton>
              </div>
        ...
        <div className="mt-16 sm:mt-10">
          <div className="bg-none sm:bg-abstract-bg-1 bg-no-repeat sm:py-24">
            <BitNobContainer className={"flex items-center sm:flex-row flex-col-reverse"}>
          ...
          <div className="bg-none sm:bg-abstract-bg-2 bg-no-repeat bg-right sm:py-24 mb-16">
            <BitNobContainer className={"flex items-center flex-col sm:flex-row"}>
          ...
          <div className="bg-none sm:bg-abstract-bg-3 bg-no-repeat bg-right sm:py-24 mb-16">
            <BitNobContainer className={"flex items-center flex-col sm:flex-row"}>
              ...
              <div className="flex-1">
                <img src="/images/split_payment_form.png" className="w-full sm:w-450" />
              </div>
            </BitNobContainer>
          </div>
          ...
          <div className="sm:py-24">
            <BitNobContainer className={"flex items-center sm:flex-row flex-col-reverse"}>
              <div className="flex-1">
                <img src="/images/team_management.png" className="w-full sm:w-500" />
              </div>
