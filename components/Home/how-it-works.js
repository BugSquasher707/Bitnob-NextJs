...
const HowItWorks = () => {
    ...
    return(
        <div className="relative mt-60">
            <div 
                className=" max-w-xs md:max-w-xl lg:max-w-md xl:max-w-3xl 2xl:max-w-5xl right-0 h-60 lg:h-80 xl:h-96 w-full bg-cover bg-no-repeat -top-20 xl:-top-32 absolute" 
                ...
                <div className="bg-bitGreen-50 xl:mt-48 rounded-2xl px-6 md:px-10 lg:px-20 pb-16 pt-52 md:pt-60 lg:pt-10">
                    <div className="flex space-x-10 items-center">
                        <div className="max-w-sm">
                            <h2 className="font-bold text-2xl md:text-5xl text-black font-gordita mb-4 md:mb-8">{howItWorks.heading}</h2>
