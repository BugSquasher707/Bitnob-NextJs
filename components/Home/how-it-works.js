...
const HowItWorks = () => {
    ...
    return(
        <div className="relative mt-60">
            <div 
                className=" max-w-xs md:max-w-xl lg:max-w-md xl:max-w-3xl 2xl:max-w-5xl right-0 h-60 lg:h-80 xl:h-80 w-full bg-cover bg-no-repeat -top-40 absolute" 
            ...
            <BitNobContainer className="px-0 md:px-6">
                <div className="bg-bitGreen-50 xl:mt-48 rounded-2xl px-6 md:px-10 lg:px-20 pb-16 pt-52 md:pt-60 lg:pt-10">
                    <div className="flex space-x-10 items-center mt-40">
                        <h2 className="font-bold text-2xl lg:text-3xl text-black font-gordita">{howItWorks.heading}</h2>
                    </div>
                    <div className="flex flex-col lg:flex-row mt-20 xl:mt-16 space-y-10 lg:space-y-0 lg:space-x-10 lg:justify-center mb-10">
                        {
