...
const HowItWorks = props => {
    ...
    return(
        <div className="relative">
            ...
            <BitNobContainer>
            <div className="bg-bitGreen-50 mt-48 rounded-2xl px-20 pb-16 pt-10">
                ...
                <div className="flex mt-28 space-x-10 justify-center mb-10">
                {
                    ...
                    <div key={title} className="space-y-4 p-8 hover:bg-white hover:shadow-xl cursor-default transition-all duration-400 rounded-2xl max-w-xs">
                        ...
                        <p className="text-bitGray-200 pb-1 block font-quicksand">{description}</p>
