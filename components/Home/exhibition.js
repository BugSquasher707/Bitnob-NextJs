        ...
        <div className="mt-28">
            ...
            <div className="flex flex-col items-center justify-center relative">
                    ...
                    return(
                        <div className="relative">
                            <div 
                                ...
                                className="px-14 py-4 bg-white whitespace-pre text-black font-bold border font-gordita text-md 2xl:text-lg rounded-3xl">
                                {title}
                ...
                <div className="flex w-full -mt-60 justify-around items-center">
                    <Arrow2 className="z-20 hover:opacity-80 transition-all transform scale-75 2xl:scale-90 duration-150 cursor-pointer" />
                    <Arrow2 className="z-20 transform scale-75 2xl:scale-90 -rotate-180 hover:opacity-90 transition-all duration-150 cursor-pointer" />
                </div>
