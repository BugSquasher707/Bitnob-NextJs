    ...
    return(
        <div className="mt-28">
            ...
            <div className="flex flex-col items-center justify-center relative">
                ...
                <div className="flex ml-8 mt-32 md:mt-64 lg:mt-40">
                    {
                        homeData.slides.map(({image}, i)=> {
                            ...
                            const style = {
                                height: "450px",
                                marginTop: `-${[1,2].includes(i) ? (mobile && window?.innerWidth < 700 ? "20" : "90") : ""}px`,
                ...
                <div className="flex w-full -mt-32 md:-mt-60 space-x-20 md:space-x-0 justify-between md:justify-around items-center">
                ...
                <Circle className=" max-w-xs md:max-w-md lg:max-w-3xl z-0 top-52 md:top-96 lg:top-0 absolute" />
            </div>
            </BitNobContainer>
        </div>
    )
