    ...
    return(
        <div className={`mt-40 bg-gradient-to-b from-white via-bitGreen-100 to-white relative ${styles.reviews}`}>
            ...
            <div className="max-w-2xl text-center mx-auto"> 
                ...
                <h2 className="font-bold leading-tight text-4xl 2xl:text-5xl text-black font-gordita mb-2">{homeData.reviews.heading}</h2>
                <p className="text-md text-bitGray-200 font-quicksand">{homeData.reviews.description}</p>
                </div>
                ...
                </div>
                {
                    ...
                    return <img src={a} style={loci?.[i]} alt="avatar" className="absolute h-28 w-28 bg-bitGreen-50 rounded-full z-30" />
                    })
                }
            </div>
            </BitNobContainer>
