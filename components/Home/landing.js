...
import { BitNobContainer, BitNobLink, Page } from "../";
      ...
      <div className="relative xl:mt-5 overflow-hidden">
        <BitNobContainer>
          <div className="flex flex-col lg:flex-row w-full pt-10 md:pt-20 lg:justify-between">
            <div
              style={{
                minHeight: isBrowser()?.innerWidth > 768 ? "600px" : "400px",
              }}
            ...
            >
              ...
              >
                ...
                <p className="mt-6 max-w-md text-xs md:text-sm xl:text-md font-quicksand font-light opacity-90 text-bitGray-200">
                  {landing.description[0]}
                </p>
                <p className="mt-2 max-w-md text-xs md:text-sm xl:text-md font-quicksand font-light opacity-90 text-bitGray-200">
            ...
            <div
              className={classNames(
                `flex-1 justify-end mt-10 md:mt-8 lg:mt-0 relative`,
                { flex: visible, hidden: !visible },
                styles.landing_cover
              )}
            >
              <figure
                ref={phoneRef}
                className={classNames("phone z-10 relative", styles.phone)}
              >
                <Image
                  src={landing.cover}
                  alt="smatphone"
        ...
        <div
          className={`${styles.product_bg} bg-bitGreen-temp z-0 absolute rounded-3xl`}
        />
      </div>
    </Page>
  );
